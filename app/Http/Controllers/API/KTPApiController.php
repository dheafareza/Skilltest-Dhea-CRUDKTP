...
class KTPApiController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Mengambil data KTP dan mengurutkan dari yang terbaru
        $ktps = Ktp::orderBy('created_at', 'desc')->paginate(8, ['*'], 'page', $page);
    
        // Format respon JSON dengan properti pagination lengkap
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('foto')) {
            ...
            $fotoPath = 'foto_ktp/profile.jpg'; // Path ke foto default di folder storage/foto_ktp
        }        
